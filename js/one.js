...
// $(document).ready(function() {
//   var scrollstart = $('.banner').height()+$('nav').height() + 150;
//   document.getElementById("bg1").style.top = scrollstart + "px";
//   document.getElementById("bg2").style.top = scrollstart + "px";
//   document.getElementById("bg3").style.top = scrollstart + "px";
...
// // the second animation in the banner
